...
class RegimeModel(Model):
    ...
    def __init__(self, num_nodes, productivity, demand, network_parameter,
        ...
        self.G = nx.barabasi_albert_graph(n=self.num_nodes, m=int(0.5*network_parameter*num_nodes)+1)
